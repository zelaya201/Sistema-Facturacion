...
public class Factura extends javax.swing.JPanel {
    ...
    public Factura(ArrayList<classes.Factura> registro, ArrayList<classes.Producto> productos) {
        initComponents();
    ...
    private void btnNuevaFacturaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevaFacturaMouseClicked
        NuevaFactura nueva = new NuevaFactura(new JFrame(), true, this, productos);
