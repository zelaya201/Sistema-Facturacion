...
public class NuevaFactura extends javax.swing.JDialog {
    ...
    public NuevaFactura(java.awt.Frame parent, boolean modal, Factura factura, ArrayList<classes.Producto> productos) {
        super(parent, modal);
        initComponents();
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(tfVendedor, javax.swing.GroupLayout.DEFAULT_SIZE, 293, Short.MAX_VALUE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(tfDireccion, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                                        .addGap(21, 21, 21)
                                        .addComponent(lbNoFactura))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(tfDui, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(tfFecha, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnAddProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddProductosMouseClicked
        AgregarProducto agregar = new AgregarProducto(new JFrame(), true, this, temp, productos);
