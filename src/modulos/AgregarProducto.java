...
public class AgregarProducto extends javax.swing.JDialog {
    ...
    public AgregarProducto(java.awt.Frame parent, boolean modal, NuevaFactura newFactura, ArrayList<classes.Detalle> detalle, ArrayList<classes.Producto> productos) {
        super(parent, modal);
        initComponents();
